		...
		<table>
			...
			<tbody>
				...
				<tr>
					<td>Mảng:</td>
					<td>
						<input type="text" name="mang_so" disabled="disabled" value="<?php xuat_mang($mang_so); ?>"
						/>
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" name="gtln" disabled="disabled" value="<?php tim_max($mang_so); ?>"
						/>
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" name="ttnn" disabled="disabled" value="<?php tim_min($mang_so); ?>"
						/>
					</td>
				</tr>
				<tr>
					<td>Tổng mảng:</td>
					<td>
						<input type="text" name="tong" disabled="disabled" value="<?php tinh_tong($mang_so); ?>"
						/>
					</td>
				</tr>
			</tbody>
